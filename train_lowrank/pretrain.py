...
class PretrainGame(Game):
    ...
    def __init__(self, e=0.2, holes=3, grid_size=8, num_neurons = 512, max_size=20, random_seed=0, set_reward=0, time_limit=100,
        ...
        self.net = RNN(9, num_neurons, 4).cuda()
...
#                 {'params': self.net.r2h, 'lr': lr_rate, 'weight_decay':0},
                ...
                {'params': self.net.U, 'lr': lr_rate, 'weight_decay':decay},
                {'params': self.net.S, 'lr': lr_rate, 'weight_decay': decay},
                {'params': self.net.V, 'lr': lr_rate, 'weight_decay': decay},
...
#         print ('matrix', self.net.U.is_cuda, self.net.V.is_cuda, self.net.S.is_cuda, self.net.a2h.is_cuda)
        ...
        self.net.h2h = self.net.W0 + self.net.U.matmul(torch.diag(self.net.S)).matmul(self.net.V)
        for epochs in range (50):
                ...
                for p, name in zip([self.net.i2h, self.net.a2h, self.net.U, self.net.V, self.net.S, self.net.bh],\
                                   ['i2h','a2h', 'U', 'V', 'S', 'bh'] ):
