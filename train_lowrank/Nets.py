...
#       need to take the state dict as a new dict for updating 
    ...
    def pretrain(self, trial, weight = None, lr = 1e-5, pretrain = True, beta = 1e-2, beta_min = 1e-2, beta_max = 1):  
        ...
        print ('pretrain end', torch.norm(self.pregame.net.W0 + self.pregame.net.U.matmul(torch.diag(self.pregame.net.S)).matmul(self.pregame.net.V)), torch.norm(self.pregame.net.a2h))
