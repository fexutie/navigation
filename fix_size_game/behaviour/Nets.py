...
#       need to take the state dict as a new dict for updating 
    ...
    def qlearn(self, weight_read, weight_write, iterations = 5, save = True, size_train = np.arange(10, 51, 10), size_test = [10, 30], train_only = False, test_only = False, noise = 0.3, k_action = 1, h2o = True):
...
def trajectory(game, pos0, reward_control = 0, init_hidden = True, hidden = torch.zeros(1, 512), size = 19, test = 2, limit_set = 4, animate = False, force_actions = []):
