...
def Strategy_count(weight, size = 15, T = 5000, reward_control = 0):
    Hiddens = []
    Poss = []
    Actions = []
    States = []
    ...
    #     start = (5, 4)
        Pos, hidden, dh, Action, State, reward, history = trajectory(Pretest.game, start, reward_control = reward_control, size = size, test = 0, \
                                                                            init_hidden = True, hidden = hidden, animate = True)
