...
def trajectory(game, pos0, reward_control = 0, init_hidden = True, hidden = torch.zeros(512, 512), size = 19, test = 2, epsilon = 0, limit_set = 32):
...
def trajectory_empty(pos0, game, Stim, reward_control = 0, action_ = [], e = 0, open_loop = True):
