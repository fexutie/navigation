...
def trajectory(game, pos0, reward_control = 0, init_hidden = True, hidden = torch.zeros(512, 512), size = 19, test = 2, scale = 1):
    game.reset(set_agent = pos0, reward_control = reward_control, size = size, limit_set = 32, test = test, train = False, scale = scale)
    done = False
    if init_hidden == True:
