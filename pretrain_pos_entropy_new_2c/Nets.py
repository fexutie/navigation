...
class PretrainTest():
    def __init__(self, weight_write, holes = 0, inputs_type = (0, 0), k_action = 1, k_internal = 1):
        self.pregame = PretrainGame(grid_size = (15, 15), holes = holes, random_seed = 4 , set_reward = [(0.5, 0.25), (0.5, 0.75)], input_type = inputs_type[0], k_action = k_action, k_internal = k_internal)
